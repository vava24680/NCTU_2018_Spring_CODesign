...
`timescale 1 ns / 1 ps
    ...
    localparam integer TRANSFER_BURST_LENGTH = 32;
    localparam integer MAX_X_POS = GROUP_WIDTH - FACE_BUFFER_WIDTH;
    localparam integer MAX_Y_POS = GROUP_HEIGHT - FACE_BUFFER_HEIGHT;
    ...
    (* mark_debug = "true" *)reg innerShiftDataSignal;
...
//Forward movement occurs when the write channel is valid and ready
    ...
    begin
        if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1)
            ...
            case (gState)
                gREAD_UP_FACE: begin
                    axi_araddr <= axi_araddr + 128;
                end
                gREAD_DOWN_FACE: begin
                    axi_araddr <= (remainRowsSubsOne == 5'd0) ? group_src_addr : axi_araddr + 128;
                end
                gREAD_UP_GROUP, gREAD_DOWN_GROUP, gREAD_EXTRA_SIXTEEN_ROWS: begin
                    axi_araddr <= axi_araddr + (GROUP_WIDTH << 2);
                end
                gCOMPUTE: begin
                    ...
                    axi_araddr <= ( (axi_araddr - group_src_addr) >= ( ( (GROUP_HEIGHT - 1) * GROUP_WIDTH ) << 2) ) ? group_src_addr + ( (xIndexNow + 32'd1) << 2)  : axi_araddr + (GROUP_WIDTH << 2);
                end
                default: begin
    ...
    */
        ...
        if (rnext)
            begin
                for(outerLoopIndex = 0; outerLoopIndex < TRANSFER_BUFFER_HEIGHT; outerLoopIndex = outerLoopIndex + 1)
                    begin
                        transferBuffer[outerLoopIndex][0] <= (outerLoopIndex == i_index && j_index == 0) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][0];
                        transferBuffer[outerLoopIndex][1] <= (outerLoopIndex == i_index && j_index == 1) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][1];
                        transferBuffer[outerLoopIndex][2] <= (outerLoopIndex == i_index && j_index == 2) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][2];
                        transferBuffer[outerLoopIndex][3] <= (outerLoopIndex == i_index && j_index == 3) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][3];
                        transferBuffer[outerLoopIndex][4] <= (outerLoopIndex == i_index && j_index == 4) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][4];
                        transferBuffer[outerLoopIndex][5] <= (outerLoopIndex == i_index && j_index == 5) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][5];
                        transferBuffer[outerLoopIndex][6] <= (outerLoopIndex == i_index && j_index == 6) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][6];
                        transferBuffer[outerLoopIndex][7] <= (outerLoopIndex == i_index && j_index == 7) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][7];
                        transferBuffer[outerLoopIndex][8] <= (outerLoopIndex == i_index && j_index == 8) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][8];
                        transferBuffer[outerLoopIndex][9] <= (outerLoopIndex == i_index && j_index == 9) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][9];
                        transferBuffer[outerLoopIndex][10] <= (outerLoopIndex == i_index && j_index == 10) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][10];
                        transferBuffer[outerLoopIndex][11] <= (outerLoopIndex == i_index && j_index == 11) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][11];
                        transferBuffer[outerLoopIndex][12] <= (outerLoopIndex == i_index && j_index == 12) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][12];
                        transferBuffer[outerLoopIndex][13] <= (outerLoopIndex == i_index && j_index == 13) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][13];
                        transferBuffer[outerLoopIndex][14] <= (outerLoopIndex == i_index && j_index == 14) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][14];
                        transferBuffer[outerLoopIndex][15] <= (outerLoopIndex == i_index && j_index == 15) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][15];
                        transferBuffer[outerLoopIndex][16] <= (outerLoopIndex == i_index && j_index == 16) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][16];
                        transferBuffer[outerLoopIndex][17] <= (outerLoopIndex == i_index && j_index == 17) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][17];
                        transferBuffer[outerLoopIndex][18] <= (outerLoopIndex == i_index && j_index == 18) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][18];
                        transferBuffer[outerLoopIndex][19] <= (outerLoopIndex == i_index && j_index == 19) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][19];
                        transferBuffer[outerLoopIndex][20] <= (outerLoopIndex == i_index && j_index == 20) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][20];
                        transferBuffer[outerLoopIndex][21] <= (outerLoopIndex == i_index && j_index == 21) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][21];
                        transferBuffer[outerLoopIndex][22] <= (outerLoopIndex == i_index && j_index == 22) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][22];
                        transferBuffer[outerLoopIndex][23] <= (outerLoopIndex == i_index && j_index == 23) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][23];
                        transferBuffer[outerLoopIndex][24] <= (outerLoopIndex == i_index && j_index == 24) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][24];
                        transferBuffer[outerLoopIndex][25] <= (outerLoopIndex == i_index && j_index == 25) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][25];
                        transferBuffer[outerLoopIndex][26] <= (outerLoopIndex == i_index && j_index == 26) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][26];
                        transferBuffer[outerLoopIndex][27] <= (outerLoopIndex == i_index && j_index == 27) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][27];
                        transferBuffer[outerLoopIndex][28] <= (outerLoopIndex == i_index && j_index == 28) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][28];
                        transferBuffer[outerLoopIndex][29] <= (outerLoopIndex == i_index && j_index == 29) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][29];
                        transferBuffer[outerLoopIndex][30] <= (outerLoopIndex == i_index && j_index == 30) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][30];
                        transferBuffer[outerLoopIndex][31] <= (outerLoopIndex == i_index && j_index == 31) ? M_AXI_RDATA[7:0] : transferBuffer[outerLoopIndex][31];
                    end
            end
        else
            begin
    ...
    always @ ( posedge M_AXI_ACLK ) begin
        if(M_AXI_ARESETN == 1'b0)
            innerShiftDataSignal <= 1'b0;
        else if(startAdderSignal)
            innerShiftDataSignal <= 1'b1;
        else if(cCounter == 5'd15 || (yIndexNow + 12'd6 == MAX_Y_POS))
            innerShiftDataSignal <= 1'b0;
        else
            innerShiftDataSignal <= innerShiftDataSignal;
    end
    ...
    always @ ( posedge M_AXI_ACLK ) begin
        if(gState == gINITIAL || (xIndexNow == MAX_X_POS && reachBottomSignal))
            xIndexNow <= 12'd0;
        //else if(yIndexNow == MAX_Y_POS)
