...
`timescale 1 ns / 1 ps
    ...
    localparam cCOMPUTE_ABS = 4'd1;
    localparam cFIRST_GROUP = 4'd2;
    localparam cSECOND_GROUP = 4'd3;
    localparam cTHIRD_GROUP = 4'd4;
    localparam cFOURTH_GROUP = 4'd5;
    localparam cADDER = 4'd6;
    localparam cCOMPLETE_COMPARE = 4'd7;
...
//Forward movement occurs when the write channel is valid and ready
    ...
    */
    ...
    always @ (posedge M_AXI_ACLK) begin
        ...
        else if(cState == cCOMPLETE_COMPARE)
            miniSAD <= (adderResult_3 < miniSAD) ? adderResult_3 : miniSAD;
        else
            miniSAD <= miniSAD;
    end
